...
// Initialize Firebase
var config = {
    apiKey: "AIzaSyCKFDTmaT0BrA_zZGzgYwickA1dvOAUC14",
    authDomain: "fir-appbuild.firebaseapp.com",
    databaseURL: "https://fir-appbuild.firebaseio.com",
    storageBucket: ""
  };
  
  firebase.initializeApp(config);
  
  //Starts up the Firebase database
  var trainData = firebase.database();
  
  // 2. Populate Firebase Database with initial data (in this case, I did this via Firebase GUI)
  // 3. Button for adding trains
  $("#add-train-btn").on("click", function(event) {
    // Prevent the default form submit behavior such as loading a Blank page, refreshing the page etc.
